...
class LRW1000_Dataset(Dataset):
    ...
    def __init__(self, index_file, target_dir):
        ...
        for item in data:
            ...
            audio_file = 'LRW1000/audio/' + audio_file + '.npy'
    ...
    def get_video_audio_map(self):
        ...
        self.anno = 'LRW1000/info/all_audio_video.txt'
...
if (__name__ == '__main__'):
    ...
    for subset in ['val']:
        target_dir = f'LRW1000_pkl_jpeg/{subset}'
        index_file = f'LRW1000/info/{subset}_1000.txt'
